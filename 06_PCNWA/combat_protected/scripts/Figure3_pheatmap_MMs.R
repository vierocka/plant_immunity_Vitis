# path corrected: the old "WGCNA/Fig4_data_metamodules.csv" never existed (no
# such WGCNA/ subfolder or Fig4-named file) -- the real data is Fig3_data_metamodules.csv
tab <- read.table("06_PCNWA/combat_protected/results/Fig3_data_metamodules.csv", header = TRUE, sep="\t")
head(tab)
dim(tab)
