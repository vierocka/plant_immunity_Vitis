...
# ID conversion
convTab <- read.table("06_PCNWA/26169genes_conversions_gene_protein_IDs.tsv", sep="\t", header = FALSE)
# raw counts: 26169
...
### PLOT: cut-off
# jpeg("/home/veve/Dropbox/MendelUni_Vinselect/draft/Sections_by_VK/MPMI/Supplementary_figures/Supplementary_Figure_6.jpg")
