...
| ST5 | Full per-gene DESeq2 differential-transcription results (9,459 DEGs), per the proof's own in-text citation | not duplicated in this GitHub repo (file too large to bundle) | Deposited in Zenodo under DOI 10.5281/zenodo.21623285 (own-study processed-data deposit), per the manuscript's Data Availability statement — **available there, not a genuine gap** |
