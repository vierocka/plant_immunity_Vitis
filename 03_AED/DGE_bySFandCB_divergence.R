...
# t6: 0.339366516 0.176470588 0.009049774**
# t24: 0.009049774 0.045248869* 0.013574661*
...
# t0: 0.11635423 0.02443439* 0.02443439*
# t6: 0.33936652 0.19852941 0.02443439*
# t24: 0.02443439* 0.06787330 0.02443439*
## Rpv12+3+1 at 0, 6 and 24 hpi; Rpv12+1 at 0; Rpv12 at 24 hpi

dens0 <- density(AD_Ho_t0)
dens6 <- density(AD_Ho_t6)
dens24  <- density(AD_Ho_t24)

# svglite("AED/AggregatedExprDivergence.svg", width = 10, height = 8)
# pdf("AED/AggregatedExprDivergence.pdf", width = 10, height = 8)
